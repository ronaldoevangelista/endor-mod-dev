...
class Packager {
    ...
    build() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.devMetadata = deepAssign_1.deepAssign((yield util_1.readPackageJson(devPackageFile)), this.options.devMetadata);
            ...
            if (appPackageFile === devPackageFile) {
                ...
                this.metadata = deepAssign_1.deepAssign((yield util_1.readPackageJson(appPackageFile)), this.options.appMetadata);
            }
